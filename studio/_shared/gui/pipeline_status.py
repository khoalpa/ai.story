...
from studio._shared.gui.lock_flags import workspace_lock_flags
from studio._shared.gui.workspace_handoff import workspace_handoff_state
from studio._shared.gui.workspace_navigation import workspace_navigation_state
