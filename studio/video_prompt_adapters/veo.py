...
class VeoAdapter:
    ...
    def project_clip(self, clip: Mapping[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "previous_last_frame_required": refs.get("previous_last_frame_required"),
            "previous_output_last_frame": refs.get("previous_output_last_frame"),
            "previous_output_video_required": refs.get("previous_output_video_required"),
