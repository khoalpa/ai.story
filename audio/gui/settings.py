...
def render_settings_sidebar() -> GuiConfigBundle:
    ...
    with st.sidebar:
        ...
        st.session_state.setdefault(VOICE_NARRATOR_SPEED_KEY, int(profile_defaults.get(VOICE_NARRATOR_SPEED_KEY) or app_defaults.get(VOICE_NARRATOR_SPEED_KEY) or 12))
        st.session_state.setdefault(VOICE_FEMALE_SPEED_KEY, int(profile_defaults.get(VOICE_FEMALE_SPEED_KEY) or app_defaults.get(VOICE_FEMALE_SPEED_KEY) or 14))
        st.session_state.setdefault(VOICE_MALE_SPEED_KEY, int(profile_defaults.get(VOICE_MALE_SPEED_KEY) or app_defaults.get(VOICE_MALE_SPEED_KEY) or 10))
        st.session_state.setdefault(VOICE_EN_NARRATOR_SPEED_KEY, int(profile_defaults.get(VOICE_EN_NARRATOR_SPEED_KEY) or app_defaults.get(VOICE_EN_NARRATOR_SPEED_KEY) or 12))
        st.session_state.setdefault(VOICE_EN_FEMALE_SPEED_KEY, int(profile_defaults.get(VOICE_EN_FEMALE_SPEED_KEY) or app_defaults.get(VOICE_EN_FEMALE_SPEED_KEY) or 13))
        st.session_state.setdefault(VOICE_EN_MALE_SPEED_KEY, int(profile_defaults.get(VOICE_EN_MALE_SPEED_KEY) or app_defaults.get(VOICE_EN_MALE_SPEED_KEY) or 11))
        ...
        voice_narrator_speed = int(st.session_state.get(VOICE_NARRATOR_SPEED_KEY) or 12)
        voice_female_speed = int(st.session_state.get(VOICE_FEMALE_SPEED_KEY) or 14)
        voice_male_speed = int(st.session_state.get(VOICE_MALE_SPEED_KEY) or 10)
        voice_en_narrator_speed = int(st.session_state.get(VOICE_EN_NARRATOR_SPEED_KEY) or 12)
        voice_en_female_speed = int(st.session_state.get(VOICE_EN_FEMALE_SPEED_KEY) or 13)
        voice_en_male_speed = int(st.session_state.get(VOICE_EN_MALE_SPEED_KEY) or 11)
