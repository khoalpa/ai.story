...
VOICE_SPEED_DEFAULTS: dict[str, object] = {
    VOICE_NARRATOR_SPEED_KEY: 25,
    VOICE_FEMALE_SPEED_KEY: 25,
    VOICE_MALE_SPEED_KEY: 25,
    VOICE_EN_NARRATOR_SPEED_KEY: 25,
    VOICE_EN_FEMALE_SPEED_KEY: 25,
    VOICE_EN_MALE_SPEED_KEY: 25,
}
