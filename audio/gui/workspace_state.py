...
from audio.gui.workspace_navigation import (
...
from audio.gui.lock_flags import (
...
from audio.gui.pipeline_status import compute_pipeline_status
from audio.gui.workspace_source_outputs import (
    WORKSPACE_SOURCE_OUTPUT_DEFAULTS,
    workspace_source_outputs,
)
from audio.gui.workspace_handoff import (
